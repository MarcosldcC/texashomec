...
const services = [
  ...
  },
  {
    ...
    details: [
      ...
      'Unique structural and aesthetic features',
      'Sustainable and energy-efficient builds',
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-body text-lg text-gray-300 leading-relaxed mb-8">
            From the ground up or a fresh start — Texas Home Construction delivers reliable,
            high-quality results across every type of project.
          </p>
          <Link
            href="/#contact"
            className="inline-flex items-center justify-center min-h-[44px] px-8 py-3 bg-accent text-primary font-heading font-semibold text-base rounded hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 transition-colors"
          >
            Get a Free Quote
          </Link>
        </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="list-disc list-inside space-y-1">
                {service.details.map((detail) => (
                  <li key={detail} className="font-body text-sm text-gray-600">
                    {detail}
                  </li>
                ))}
              </ul>
              <Link
                href="/#contact"
                className="inline-flex items-center justify-center self-start min-h-[44px] px-6 py-3 bg-accent text-primary font-heading font-semibold text-sm rounded hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 transition-colors"
              >
                Get a Quote
              </Link>
            </div>
      ...
      <section className="w-full bg-primary py-16 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="font-body text-base text-gray-300 mb-8">
            Contact us today for a free consultation and quote. Our team is ready to bring your
            vision to life.
          </p>
          <Link
            href="/#contact"
